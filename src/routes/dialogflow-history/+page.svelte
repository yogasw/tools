<script>
  ...
  import { fetchHistory, extractChatMessages, extractIntentHistory } from '$lib/dialogflow/dialogflow-api.js';
    ...
    <div class="flex items-center justify-between px-4 py-3">
      ...
      <div class="flex items-center gap-2">
        ...
        <button
          ...
          class="px-3 py-1.5 bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg transition-colors text-xs font-medium flex items-center gap-1.5"
        >
          <svg class="w-4 h-4 transition-transform" class:rotate-180={!configCollapsed} fill="none" stroke="currentColor" viewBox="0 0 24 24">
